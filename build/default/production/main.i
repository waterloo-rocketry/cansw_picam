...
# 95
if ((millis() - last_can_traffic_timestamp_ms > 1000)
...
can_msg_t error_msg;
build_board_stat_msg(millis(), E_CODING_SCREWUP, (0), 0, &error_msg);
...
if (get_board_unique_id(msg) == 0x0B) {
return;
}
...
build_board_stat_msg(millis(), E_NOMINAL, (0), 0, &board_stat_msg);
