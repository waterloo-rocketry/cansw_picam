...
# 22 "error_checks.c"
static bool battery_voltage_critical = 0;
...
batt_voltage_mV = batt_voltage_mV * 3.95;

if (batt_voltage_mV < 8000
|| batt_voltage_mV > 9500) {

uint32_t timestamp = millis();
uint8_t batt_data[2] = {0};
batt_data[0] = (batt_voltage_mV >> 8) & 0xff;
batt_data[1] = (batt_voltage_mV >> 0) & 0xff;
enum BOARD_STATUS error_code = batt_voltage_mV < 8000
? E_BATT_UNDER_VOLTAGE
: E_BATT_OVER_VOLTAGE;
...
if (batt_voltage_mV < 7500) {

battery_voltage_critical = 1;
} else {

battery_voltage_critical = 0;
}
